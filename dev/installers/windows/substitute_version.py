...
# @brief   Replace version string in lostit_innosetup_script.iss.in
...
with open(path.join(here, 'lostit_innosetup_script.iss.in')) as infile:
    with open(path.join(here, 'lostit_innosetup_script.iss'), 'w') as outfile:
